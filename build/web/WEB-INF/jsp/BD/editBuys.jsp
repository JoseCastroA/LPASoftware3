...
<html>
    ...
    <body>
        <div class="container">
        <h1>Editar compra de un producto</h1>
             <ol class="breadcrumb">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form:form action="COMPRA_edit.htm" method="post">
                              ...
                              <td style="width:50%">   
                                ...
                                <p id="NombreNovedad">
                            		...
                            		<c:out value="${dato.disponibles}"/>
                                        <input type="hidden" id="Disponibles" name="Disponibles" value="${dato.cantidad}"/>
                        		</p>
                                        <p > 
                                            <textarea class="form-control" name="Cantidad" id="Cantidad">${dato.cantidad}</textarea>
                                        </p>
                              </td>
                            </tr>
                          </tbody>
                        ...
                        <input type="submit" value="Actualizar Compra" class="btn btn-danger"/>
